...
function CVEDetail() {
    ...
    return (
        <div>
            ...
            <p><strong>Score:</strong> {cve.metrics.cvssMetricV2[0].exploitabilityScore}</p>
            {/* <p><strong>Vector String:</strong> {cve.cvssV2?.vectorString}</p> */}
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{cve.metrics.cvssMetricV2[0].cvssData.accessVector.accessComplexity}</td>
                        <td>{cve.metrics.cvssMetricV2[0].cvssData.accessVector.authentication}</td>
                        <td>{cve.metrics.cvssMetricV2[0].cvssData.accessVector.confidentialityImpact}</td>
                        <td>{cve.metrics.cvssMetricV2[0].cvssData.accessVector.integrityImpact}</td>
                        <td>{cve.metrics.cvssMetricV2[0].cvssData.accessVector.availabilityImpact}</td>
                    </tr>
                </tbody>
            </table>
